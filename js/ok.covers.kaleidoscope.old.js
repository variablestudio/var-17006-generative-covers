...
OK.Covers.push((function() {
  ...
  function makeCover(book) {
    ...
    crayon.font("Arial", titleFontSize*0.5, "normal").fill("#000000").paragraph("left", 0.25, titleWidth, true).text(subTitle.toUpperCase(), 0, titleFontSize/4);
    ...
    crayon.style("text");
    crayon.font("Arial", titleFontSize, "bold").fill("#000000").paragraph("left", 0.25, titleWidth, true).text(title.toUpperCase());
    crayon.font("Arial", titleFontSize*0.5, "normal").fill("#999").paragraph("left", 0.25, titleWidth, true).text(subTitle.toUpperCase(), 0, -titleFontSize*0.25);
    crayon.font("Arial", authorFontSize).fill("#222222").paragraph("left", 0.25, titleWidth, true).text(author, 0, authorFontSize/2);
    crayon.restore();
