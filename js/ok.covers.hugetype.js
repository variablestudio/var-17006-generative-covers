...
function getPosition(imgData, width, height, mode) {
 ...
 var tmp_canvas2 = document.createElement("canvas");
  ...
  function makeCover(book) {
    ...
    initials[0] = author[1][0].charAt(0);
    initials[1] = author[0][0].charAt(0);
    ...
    crayon.font("OpenSansSemi", authorFontSize, author[1][1], 0).fill("#000000").paragraph("left", -0.25, titleWidth, true).text(author[1][0], 0, authorFontSize/2);
    //0 + name.pixelLength of author[1][0] + " "
    crayon.font("OpenSansSemi", authorFontSize, author[0][1], 0).fill("#000000").paragraph("left", 2, titleWidth, true).text(author[0][0], 0 , authorFontSize/2);
