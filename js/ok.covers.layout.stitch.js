...
OK.Covers.push((function () {
    ...
    function makeCover(book) {
        ...
        if (OK.Covers.Typography.longestWord(book.title) > 10) { titleFontSize = titleFontSize * OK.Covers.Utils.remap(OK.Covers.Typography.longestWord(book.title) - 10, 0, 10, 0.75, 0.5); }
    else {
