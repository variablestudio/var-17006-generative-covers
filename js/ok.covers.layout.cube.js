...

{
    ...
    year_colour = "hsla(" + yh + ", 70%, 60%, 0.4)";
    section_colour = "hsla(" + sh + ", 70%, 60%, 0.4)";
    page_colour = "hsla(" + ph +", 70%, 60%, 0.4)";
    
    //if(mix == 0) { year_color = blendIt(year_colour, c1);}
    ...
    crayon.context.stroke();
    crayon.context.fillStyle = year_colour;
    crayon.context.fill();
    crayon.context.translate(-tmp_x, -tmp_y);
    ...
    if(sections===undefined) { sec1 = Math.round(Math.random()*9+1); sec2 = Math.round(Math.random()*9+1); }
    else {
