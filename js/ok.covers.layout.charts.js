...
OK.Covers.push((function () {
    ...
    function makeCover(book) {
        ...
        heights[0] = OK.Covers.Utils.remap(parseInt(def_year.substring(0, 2)), 18, 21, 10, 30);
        heights[1] = OK.Covers.Utils.remap(parseInt(def_year.substring(2)), 0, 99, 10, 32);
        heights[2] = OK.Covers.Utils.remap(parseInt(def_pages), 0, 1000, 5, 32);
        heights[3] = OK.Covers.Utils.remap(book.title.length, 0, 200, 5, 36);
        heights[4] = OK.Covers.Utils.remap(book.author.length, 0, 120, 5, 36);
        heights[5] = OK.Covers.Utils.remap(book.publisher.length, 0, 120, 5, 36);
        ...
        if (OK.Covers.Typography.longestWord(book.title) > 10) {
            titleFontSize = titleFontSize * OK.Covers.Utils.remap(OK.Covers.Typography.longestWord(book.title) - 10, 0, 10, 0.9, 0.7);
        } else {
