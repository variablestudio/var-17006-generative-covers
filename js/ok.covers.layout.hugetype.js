...
function getPosition(imgData, width, height, mode) {
  ...
  function makeCover(book) {
    ...
    initials[0] = author.surname.charAt(0);
    initials[1] = author.name.charAt(0);
    ...
    crayon.font("OpenSansSemi", authorFontSize, author.nameStyle, 0).fill("#000000").paragraph("left", -0.25, titleWidth, true).text(author.name, 0, authorFontSize/2);
    //0 + name.pixelLength of author[1][0] + " "
    crayon.font("OpenSansSemi", authorFontSize, author.surnameStyle, 0).fill("#000000").paragraph("left", 2, titleWidth, true).text(author.surname, 0 , authorFontSize/2);
