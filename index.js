...
const covers = [
  ...
  //
  // require('./lib/covers/ok.covers.layout.hip.js'),
  //
  // require('./lib/covers/ok.covers.layout.penguin.js'),
  //
  // require('./lib/covers/layouts/moleskine.js'),
  //
  // require('./lib/covers/ok.covers.layout.header.js'),
  //
  // require('./lib/covers/ok.covers.layout.footer.js'),
  //
  // require('./lib/covers/ok.covers.layout.semiopaque.js'),
