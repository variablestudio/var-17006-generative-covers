...
Xcenter = 75 * x;
  ...
  function makeCover(book) {
    ...
    crayon.font("Arial", authorFontSize, authorInfo.nameStyle, 0).fill("#FF9000").paragraph("left", 0.25, titleWidth, false).text(authorInfo.name, 0, authorFontSize/2);
    //0 + name.pixelLength of author.name + " "
    crayon.font("Arial", authorFontSize, authorInfo.surnameStyle, 0).fill("#FF9000").paragraph("left", -0.25, titleWidth, true).text(authorInfo.surname, 0 + crayon.measureText(authorInfo.name + " ").width, authorFontSize/2);
