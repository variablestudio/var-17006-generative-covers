...
function makeCover (book) {
  ...
  var titleFontSize = crayon.canvas.height * 0.05 // 0.08

  var shiftY = 50

  var titleX = crayon.canvas.width * 0.08
  var titleY = crayon.canvas.height - 800 / 3 + 30
  ...
  crayon.context.fillRect(0, crayon.canvas.height - 800 / 3, 600, 800 / 3)
  ...
  crayon.translate(50, 800 / 3 * 2 + 60)
