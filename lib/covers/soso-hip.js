...
// crayon.context.rotate(60);
  ...
  crayon.font('Arial', authorFontSize, author.nameStyle).fill('#D6D6D6').paragraph('left', 0.5, titleWidth, false).text(author.name, 2, authorFontSize / 2)
    // 0 + name.pixelLength of author.name + ' '
  crayon.font('Arial', authorFontSize, author.surnameStyle).fill('#D6D6D6').paragraph('right', -0.5, titleWidth, true).text(author.surname, -2, authorFontSize / 2)
