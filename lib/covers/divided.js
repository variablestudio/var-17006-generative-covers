...
function makeCover (book) {
  ...
  letters[0] = author.surname[0].charAt(0)
  letters[1] = author.name[0].charAt(0)
  ...
  crayon.font('BenchNineLight', titleFontSize, 'normal').fill('#000000').paragraph('left', -0.2 * 0, titleWidth, true).text(title)
  ...
  var tmp1 = crayon.context.measureText(author.name[0] + '' + author.surname[0]).width
  crayon.context.textAlign = 'right'
  crayon.context.fillText(author.name[0], crayon.canvas.width - 50 - tmp1, 54)
  crayon.context.fillText(author.surname[0], crayon.canvas.width - 50, 54)
  // crayon.paragraph('right', 0, 0)
  // crayon.text(author.name[0], crayon.canvas.width - 50 - tmp1, 54)
  // crayon.text(author.surname[0], crayon.canvas.width - 50, 54)
