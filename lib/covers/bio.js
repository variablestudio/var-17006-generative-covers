...
function makeCover (book) {
  ...
  crayon.restore()
  //crayon.font('Arial', authorFontSize, author.name[1], 0).fill('#FF9000').paragraph('left', 0.25, titleWidth, false).text(author.name[0], 0, authorFontSize/2);
  //0 + name.pixelLength of author.name[0] + ' '
  //crayon.font('Arial', authorFontSize, author.surname[1], 0).fill('#FF9000').paragraph('left', -0.25, titleWidth, true).text(author.surname[0], 0 + crayon.measureText(author.name + ' ').width, authorFontSize/2);
