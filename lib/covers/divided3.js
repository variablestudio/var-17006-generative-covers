...
function makeCover (book) {
  ...
  var tmp = crayon.context.measureText(author.surname[0] + '').width
  ...
  // crayon.context.fillText(author.surname[0], quarter_x, quarter_width / 2)
  // crayon.translate(tmp, 0);
  // crayon.font("UbuntuCondensed", authorFontSize, author.surname[1]).fill("#313131").paragraph("left", -0.25, titleWidth, true).text(author.surname[0], 0, authorFontSize/2);
